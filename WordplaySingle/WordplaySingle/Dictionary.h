...
Needs STL vector and std::string to keep track of the words in the dictionary, and algorithm to use binary search.
...
Dictionary(std::string)
	takes the given filepath in std::string as the source of the dictionary, and loads it all into the class
