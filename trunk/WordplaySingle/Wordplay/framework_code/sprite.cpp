...
/******************************************************
	Gets the current frame index (index starts at 0).
...
/******************************************************
	Sets the count for the number of animation frames for
	the sprite.

	@param fCount The new number of frames.
******************************************************/
...
/******************************************************
	...
	@return The width (int) in pixels
******************************************************/
int Sprite::GetWidth()
{
	return box.GetWidth();
...
/******************************************************
	...
	@return The height (int) in pixels
******************************************************/
...
/******************************************************
	Returns the currently visibility of the sprite.

	@return true if the sprite is currently visible, false otherwise
******************************************************/
...
/******************************************************
	Checks for collision with a BoundingBox object.

	@param other_box The BoundingBox to check collision against.
	@return true if collision is occuring, false otherwise
******************************************************/
...
/******************************************************
	...
	@param other_sprite The sprite to check collision against.	
	@return true if collision is occuring, false otherwise
******************************************************/
...
/******************************************************
	Changes the bitmap file reference for the sprite.

	@param ref The new reference name.	
******************************************************/
...
******************************************************/
void Sprite::SetVisible(int vis)
{
	if(vis == 0)
		visible = false;
	else
